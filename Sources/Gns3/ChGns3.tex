...
\input{Sources/Gns3/Sections/Gns3sPurposeAndRaisonDEtre}

% Section "General architecture"
\input{Sources/Gns3/Sections/Architecture}

% Section "Giving life to the topology-emulating nodes and links"
\input{Sources/Gns3/Sections/Emulating}

% % Section "Building blocks. The programs inside GNS3"
% \input{Sources/Gns3/Sections/BuildingBlocks}

% Section "Practical case study"
\input{Sources/Gns3/Sections/PracticalCaseStudy}

% Section "Performance and resources considerations"
\input{Sources/Gns3/Sections/Performance}
