...
Conversely, for the sake of testing that functionality, the routing (static and OSPF) labs were tested setting up nodes according to what's shown in <REFER TO FIGURE>. % TODO cf. § imediatamente abaixo

<INSERT A PAIR OF FIGURES, ONE SHOWING EACH TOPOLOGY, ONE WITH LOAD BALANCE THE OTHER ONE WITHOUT> % TODO esta é para inserir mesmo
