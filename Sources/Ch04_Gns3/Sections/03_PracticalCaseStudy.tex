...
Waiting 30 seconds to re-enable the link from \texttt{R1} to \texttt{R2}, we measured approximately 50 seconds until \texttt{ping}'s successful --- i.e. no timeouts --- round-trips resumed using the initial (better) route.
